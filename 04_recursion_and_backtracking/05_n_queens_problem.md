...
### Java — Board-based Solution

```java
// Java — N-Queens using Backtracking
...
public class NQueens {
    ...
    static void solve(int[][] board, int row, int n,
        ...
        for (int col = 0; col < n; col++) {
            if (isSafe(board, row, col, n)) {
                ...
                solve(board, row + 1, n, solutions); // Recurse
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total solutions for 4-Queens: " + results.size());
